    ...
    <Card className={classes.root}>
      <CardActionArea>
       <Link to="/Kashmir"> <CardMedia
          ...
          image="https://upload.wikimedia.org/wikipedia/commons/9/94/Phander_Lake%2C_Ghizer%2C_Gilgit%E2%80%93Baltistan.jpg"
          title="Contemplative Reptile"
        />
        </Link>
        <CardContent>
         <Link to="/kashmir" style={{color:'Black',textDecoration: 'none'}}> <Typography gutterBottom variant="h5" component="h2">
          <b style={{fontFamily:'Courier New'}}>PHANDER LAKE</b>
          </Typography>
